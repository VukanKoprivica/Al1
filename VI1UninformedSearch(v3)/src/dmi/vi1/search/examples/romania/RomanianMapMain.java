...
public class RomanianMapMain {
	...
	public static void main(String[] args) throws Exception {
		...
		RomanianMapActionsFunction actionsFunction = new RomanianMapActionsFunction();
		RomanianMapResultFunction resultFunction = new RomanianMapResultFunction();
		
		
		Problem p = new Problem(initialState, actionsFunction, 
								resultFunction, goalTest, costFunction );
